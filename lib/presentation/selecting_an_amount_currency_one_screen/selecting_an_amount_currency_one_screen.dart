import '../selecting_an_amount_currency_one_screen/widgets/gridone1_item_widget.dart';
...
class SelectingAnAmountCurrencyOneScreen
    extends GetWidget<SelectingAnAmountCurrencyOneController> {
  @override
            ...
            body: Container(
                ...
                child: SingleChildScrollView(
                    child: Container(
                      ...
                      Container(
                          margin: getMargin(left: 15, top: 300, right: 15),
                          child: Column(
                              mainAxisSize: MainAxisSize.min,
                                    ...
                                    child: Padding(
                                        ...
                                        child: Obx(() => GridView.builder(
                                            ...
                                            itemCount: controller
                                                .selectingAnAmountCurrencyOneModelObj
                                                .value
                                                .gridone1ItemList
                                                .length,
                                            itemBuilder: (context, index) {
                                              Gridone1ItemModel model = controller
                                                  .selectingAnAmountCurrencyOneModelObj
                                                  .value
                                                  .gridone1ItemList[index];
                                              return Gridone1ItemWidget(model);
                                            })))),
                                Align(
